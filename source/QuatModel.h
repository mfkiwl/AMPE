...
class QuatModel : public PFModel
{
 public:
   ...
   void computePhaseDiffs(const std::shared_ptr<hier::PatchHierarchy> hierarchy,
                          int& phase_id, int& phase_diffs_id, const double time,
   ...
   void computeEtaGradCell(
       ...
       const CACHE_TYPE cache = CACHE);
   void computeEtaGradCell(const std::shared_ptr<hier::PatchLevel> patch_level,
                           int& eta_diffs_id, int& eta_grad_cell_id,
                           const double time);
   ...
   void computeVarGradCell(const std::shared_ptr<hier::PatchLevel> patch_level,
                           int& diffs_id, int& grad_cell_id, const double time);
   ...
   void computeQuatDiffs(const std::shared_ptr<hier::PatchHierarchy> hierarchy,
   ...
   void computeQuatGradCell(
       const std::shared_ptr<hier::PatchHierarchy> hierarchy, int& diffs_id,
       int& grad_cell_id, const double time, const CACHE_TYPE cache = CACHE);
   void computeQuatGradCell(const std::shared_ptr<hier::PatchLevel> patch_level,
                            int& diffs_id, int& grad_cell_id,
                            const double time);

   void computeQuatGradSide(
       const std::shared_ptr<hier::PatchHierarchy> hierarchy, int& diffs_id,
       int& grad_side_id, const double time, const CACHE_TYPE cache = CACHE);
   void computeQuatGradSide(const std::shared_ptr<hier::PatchLevel> patch_level,
   ...
   void computeQuatGradModulus(
       ...
       int& grad_modulus_id, const double time, const CACHE_TYPE cache = CACHE);
   void computeQuatGradModulus(
   ...
   void computeEtaMobility(
       const std::shared_ptr<hier::PatchHierarchy> hierarchy, int& phase_id,
       int& mobility_id, const double time, const CACHE_TYPE cache = CACHE);
   void computeEtaMobility(const std::shared_ptr<hier::PatchLevel> patch_level,
                           int& phase_id, int& mobility_id, const double time);

   void computeQuatMobility(
       const std::shared_ptr<hier::PatchHierarchy> hierarchy, int& phase_id,
       int& mobility_id, const double time, const CACHE_TYPE cache = CACHE);
   void computeQuatMobility(const std::shared_ptr<hier::PatchLevel> patch_level,
                            int& phase_id, int& mobility_id, const double time);
   ...
   double evaluateVolumeSolid(
       const std::shared_ptr<hier::PatchHierarchy> hierarchy,
       const int phase_id);
   double evaluatePhaseFraction(
       const std::shared_ptr<hier::PatchHierarchy> hierarchy,
       const int phase_id, const int depth);
 ...
 private:
   ...
   std::shared_ptr<TemperatureStrategy> d_temperature_strategy_quat_only;
